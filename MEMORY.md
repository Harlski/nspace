...
- **[docs/patchnotes-release.md](docs/patchnotes-release.md)** — **how to write** public release copy (brief → developers), recommended scan order, optional **`[NEW]` / `[FIX]` / …** tags for `/patchnotes` badges; use this when drafting or reviewing `public/*.md`.
