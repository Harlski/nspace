...
- **Content**: Walkable floor planes, tile highlight, path line, identicon avatars, user-placed blocks (box, hex, pyramid, sphere, ramp, palette colors), optional admin overlay ([client/src/ui/adminOverlay.ts](../client/src/ui/adminOverlay.ts)).
