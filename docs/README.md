...
| [docker-deployment.md](docker-deployment.md) | Compose, volumes, **payout** sidecar (default), **analytics** sidecar (default), optional **payment-intent** sidecar (profile `payment`), common operations |
