...
- [NEW] System admin: `GET`/`PUT /api/admin/connections` and HTML `/admin/connections` for the Resident allowlist (`residentAddresses` in `admin-runtime-settings.json`, merged with `RESIDENT_ADDRESSES`).
