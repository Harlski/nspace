...
- [NEW] Upgrade Windows are server-owned (20s, eight Upgrades, pose at fire time, uniform random among eligible ordinary solids in Chebyshev radius 8). No Resident Upgrade HTTP.
