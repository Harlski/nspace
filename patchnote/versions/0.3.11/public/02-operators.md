# Public patch notes — operators (`0.3.11`)
...
- **This patch:** No new Docker services, compose profiles, or environment variables beyond the acknowledgement store paths above. Static hosting should still expose `/tacs` and `/privacy` on the same origin as the game when using split hosting.
